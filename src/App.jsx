...
const PACKAGES = [
  {
    ...
    price: 10000,
    meta: "30-minute recording. Full edit, vertical reels for social, and show notes that link to your Social media profiles.",
  },
];
...
const DELIVERABLES = [
  "One highlighted story, shaped around your brand and audience",
    ...
    <section className="section" id="guests">
      <div className="about__intro">
        ...
        <div className="about__side">
          <p className="lede">
            {SHOW.name} producting long-form podcast with Creator.
      ...
      <div className="audience audience--single">
        <article className="panel panel--dark">
          <h3 className="panel__title">Influencer</h3>
